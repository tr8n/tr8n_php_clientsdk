...
<div class="hero-unit">
    ...
    <p class="text-center">
        <?php tre("Tr8n for PHP is a Client SDK library that allows PHP based applications to integrate with the Tr8n crowdsourced translation platform.") ?>
        <?php tre("This sample application demonstrates some of Tr8n's capabilities.") ?>
    </p>
    <br>
    <?php if (tr8n_current_translator() == null) { ?>
        <p class="text-center">
            <a href="<?php echo tr8n_signup_url() ?>" class="btn btn-large"><?php tre("Sign up to get started today") ?></a>
        </p>
    <?php } ?>
</div>
